...
var dust_spawn_rate_min = 140
var dust_spawn_rate_max = 200
var time_before_dust_spawn = rand_time_before_dust_spawn()
var dust_wall_spawn_rate_min = .02
var dust_wall_spawn_rate_max = .03
var time_before_dust_wall_spawn = rand_time_before_dust_wall_spawn()
...
func rand_time_before_dust_wall_spawn():
	return randf_range(1.0 / dust_wall_spawn_rate_max, 1.0 / dust_wall_spawn_rate_min)
...
func spawn_dust():
	...
	# TODO: Spawn on top, bottom, left, or right edges instead of just right.
	dust.linear_velocity = Vector2(-randi_range(300, 600), 0).rotated(randf_range(deg_to_rad(-10), deg_to_rad(10)))
	dust.position = Vector2(vp.x - 1, randi_range(0, vp.y - 1))
	add_child(dust)

func spawn_dust_wall():
	var vp = Vector2(viewport_width_initial, viewport_height_initial)
...
func _process(delta):
	...
	time_before_dust_wall_spawn -= delta
	while time_before_dust_wall_spawn <= 0.0:
		spawn_dust_wall()
		time_before_dust_wall_spawn += rand_time_before_dust_wall_spawn()
